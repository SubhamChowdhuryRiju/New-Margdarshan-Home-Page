const chatbotConatainer = document.querySelector(".chatbot-container");
...
const createChatLi = (message, className) => {
  ...
  if (className === "outgoing") {
    ...
    const imgTag = `<img src="../static/images/botimg.svg" class="chat-robot"/>`;
    const chatP = document.createElement("p");
    chatP.textContent = message;
...
closeBtn.addEventListener("click", () => {
  chatbotConatainer.classList.remove("show-chatbot");
  chatbotToggler.style.opacity = "1";
});

chatbotToggler.addEventListener("click", () => {
  chatbotConatainer.classList.add("show-chatbot");
  chatbotToggler.style.opacity = "0";
});

maximiseBtn.addEventListener("click", () => {
  chatbotConatainer.classList.add("fullscreen");
...
minimiseBtn.addEventListener("click", () => {
  chatbotConatainer.classList.remove("fullscreen");
